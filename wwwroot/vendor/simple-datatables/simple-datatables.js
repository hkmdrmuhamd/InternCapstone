            ...
            (function () {
                ...
                switch (o) {
                  ...
                  case s._const.modifyTextElement:
                    ...
                    s.textDiff(
                      ...
                      f(i.parentNode, "HTMLTextAreaElement") &&
                  ...
                  case s._const.removeTextElement:
                    ...
                    var h = i.parentNode;
                    h.removeChild(i),
                      f(h, "HTMLTextAreaElement") && (h.value = "");
                    break;
                    ...
                    !(function (t, e, s) {
                      switch (e[s._const.action]) {
                        case s._const.addAttribute:
                          ...
                          break;
                        case s._const.modifyAttribute:
                          v(e, s._const.oldValue, s._const.newValue),
                            b(t, e, s);
                          break;
                        case s._const.removeAttribute:
              ...
              var P = {
                  ...
                  return (
                    t.replace(T, function (r, l) {
                      ...
                      if (d) {
                        if (
                          ("svg" ===
                            (s = R(r, e.caseSensitive || o)).node.nodeName &&
                            (o = !0),
                          n++,
                          !s.voidElement && u && "<" !== u)
                        ) {
                ...
                I = (function () {
                  function t(t, e, s) {
                    (this.options = s),
                      (this.t1 =
                        "undefined" != typeof Element && f(t, "Element")
                          ? k(t, this.options)
                          : "string" == typeof t
                          ? H(t, this.options)
                          : JSON.parse(JSON.stringify(t))),
                      (this.t2 =
                        "undefined" != typeof Element && f(e, "Element")
                          ? k(e, this.options)
                          : "string" == typeof e
                          ? H(e, this.options)
                      ...
                      for (var h = 0; h < a; h += 1) {
                        ...
                        o &&
                          ...
                          u &&
                            ...
                            a < this.options.maxChildCount
                              ? (r = r.concat(
                                  this.findNextDiff(u, f, s.concat(l))
                                ))
                              : x(u, f) ||
                                (i.length > n.length
                                  ? ("#text" === u.nodeName
                    ...
                    (t.prototype.attemptGroupRelocation = function (
                      ...
                      for (
                        var a,
                          ...
                          c = (function (t, e, s) {
                            var i = t.childNodes
                                ? E(t.childNodes.length, !0)
                                : [],
                              n = e.childNodes
                                ? E(e.childNodes.length, !0)
                                : [],
                              a = 0;
                            return (
              ...
              const et = {
                  ...
                  labels: {
                    ...
                    perPage: "Sayfa başına gösterilecek kayıt",
                    pageTitle: "Page {page}",
                    noRows: "Kayıt bulunamadı",
                    noResults: "Aradığınız kayıt bulunamadı",
                    info: "{rows} kayıtttan {start} - {end} gösteriliyor",
                  },
                  template: (t, e) =>
